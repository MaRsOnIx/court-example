...
class JudgeConfiguration {
    ...
    @Bean
    JudgeEventHandler judgeEventHandler(KafkaTemplate<String, Object> kafkaTemplate){
        return new JudgeEventHandlerTermImpl(JudgeCachedDataStore.INSTANCE, kafkaTemplate);
    }
}
